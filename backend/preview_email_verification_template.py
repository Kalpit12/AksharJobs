#!/usr/bin/env python3
"""
Create a preview of the email verification template
"""

from datetime import datetime

def create_email_verification_preview():
    """Create a preview of the email verification template"""
    
    # Sample data
    user_name = "John Kamau"
    user_email = "john.kamau@example.com"
    verification_code = "747832"
    ...
    # Save to file
    with open("email_verification_template_preview.html", "w", encoding="utf-8") as f:
        f.write(email_html)
    
    print("✅ Email verification template preview created!")
    print("📁 Saved as: email_verification_template_preview.html")
    print("\n🎨 Email Features:")
    print("   ✨ Premium gradient header with AksharJobs branding")
    print("   🚀 'Kenya's Premier Job Platform' tagline")
    print("   🔑 Large, prominent verification code display")
    print("   ⚠️ Important security warnings")
    print("   ℹ️ Step-by-step verification instructions")
...
if __name__ == "__main__":
    create_email_verification_preview()
