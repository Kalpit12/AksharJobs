...
import { faEye, faEyeSlash, faUser, faLock, faArrowRight, faCheck, faUsers, faBriefcase, faChartLine, faShieldAlt } from '@fortawesome/free-solid-svg-icons';
        ...
        >
          <div className="left-content">
            ...
            <div className="testimonial">
              <div className="quote">
                <p>"AksharJobs helped me find my dream job in just 2 weeks. The platform is intuitive and the opportunities are amazing!"</p>
                <div className="author">
                  <span className="name">Sarah Johnson</span>
                  <span className="role">Software Engineer at TechCorp</span>
                </div>
              </div>
            </div>
          </div>
